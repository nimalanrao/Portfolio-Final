      ...
      <div className="max-w-7xl mx-auto px-6 space-y-12 relative z-10">
        <div className="flex items-end justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              onClick={goToPrev}
              className="w-12 h-12 rounded-full liquid-glass flex items-center justify-center text-primary-cream hover:bg-white/10 transition-all duration-300 hover:scale-110 active:scale-95"
            >
            ...
            return (
              ...
              >
                <div
                  ...
                  className={`liquid-glass p-6 rounded-[2rem] flex flex-col group transition-all duration-500 h-full hover:shadow-[0_0_40px_rgba(222,219,200,0.15)] relative overflow-hidden cursor-pointer bg-gradient-to-br from-transparent to-transparent hover:from-primary/5 hover:to-transparent ${project.isPlaceholder ? 'opacity-60 grayscale cursor-default' : ''}`}
                >
                  {/* Subtle Torch effect */}
