...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["UI/UX Design", "Figma", "Content Creation", "Video Editing", "Brand Design"]
  },
  {
    title: "Marketing",
    icon: <TrendingUp className="w-5 h-5" />,
    skills: ["SEO", "Social Media Strategy", "Consumer Psychology", "Digital Branding"]
  },
  {
    title: "Operations",
    icon: <Briefcase className="w-5 h-5" />,
    skills: ["Customer Service", "Teamwork", "POS Systems", "Time Management"]
  }
];

export default function SectionExpertise() {
  return (
    <section id="expertise-container" className="bg-black py-32 px-4 sm:px-8 relative overflow-hidden">
